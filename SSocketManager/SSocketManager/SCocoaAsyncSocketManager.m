...
static const uint16_t Kport = 50284;

@interface SCocoaAsyncSocketManager ()<GCDAsyncSocketDelegate>

@property (nonatomic, strong) GCDAsyncSocket *gcdSocket;

@end

@implementation SCocoaAsyncSocketManager

+ (instancetype)share
{
    static dispatch_once_t onceToken;
    static SCocoaAsyncSocketManager *instance = nil;
